...
<input placeholder="Enter Title" required value="{{old('product')}}" type="txt" class="form-control" name="product">
</br>

<label>Details of Product</label>
<textarea name="details" id="input" type="txt" class="form-control m-3 p-3" 
rows="3" cols="40" required="required"> {{old('details')}}</textarea>
</br>
